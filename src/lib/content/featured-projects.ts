  ...
  projects: [
    {
      ...
      img: '/brq-itau.jpg', // Placeholder, substituir por imagem real
      tags: ['Android', 'Kotlin', 'Java', 'Jetpack Compose', 'MVVM', 'Testes', 'CI/CD', 'Banking'],
      //imagens-projetos-rascunho/flex-painel-controele-project-dotNet.jpgrepo: '', // Provavelmente um projeto privado, deixar vazio ou usar GitHub geral se houver conteúdo público
    },
    {
      id: getId(),
      ...
      url: 'https://www.flexautomation.com.br/produtos', // Link para a empresa
      img: '/flex-painel-controle-project-dotNet.jpg', // Placeholder, substituir por imagem real
    ...
    },
    {
      ...
      url: 'https://www.auditbs.com.br/Servicos.html', // Link para a empresa
      img: '/controlquest.jpg', // Placeholder, substituir por imagem real
